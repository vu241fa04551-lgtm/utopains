...
export default async function AdminDashboardPage() {
  ...
  const [userCount, courseCount, publishedCount, enrollmentCount, problemCount, publishedProblemCount, attemptCount] =
    await Promise.all([
      prisma.user.count(),
      prisma.course.count(),
      ...
      prisma.practiceProblem.count({ where: { published: true } }),
  ...
  const stats = [
    ...
    { label: "Practice problems", value: problemCount, href: "/admin/courses" },
    { label: "Published problems", value: publishedProblemCount, href: "/admin/courses" },
    { label: "Practice attempts", value: attemptCount, href: "/admin/courses" },
  ];
